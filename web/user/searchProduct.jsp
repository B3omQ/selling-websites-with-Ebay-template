                ...
                <div>
                    <ul class="mb-4">
                        <li class="relative inline-block text-left">
                            <button id="dropdownPrice" class="flex">
                                <span>Price</span>
                                <svg class="ml-2 w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"/>
                                </svg>
                            </button>
                            <div id="dropdownPriceMenu" class="left-1">
                                <label class="block px-4 py-2">
                                    <input type="radio" name="sortPrice" value="low-to-high" class="mr-2"> Price: Low to High
                                </label>
                                <label class="block px-4 py-2">
                                    <input type="radio" name="sortPrice" value="high-to-low" class="mr-2"> Price: High to Low
                                </label>
                            </div>
                        </li>

                        <li class="relative inline-block text-left">
                            <button id="dropdownSort" class="flex">
                                <span>Name</span>
                                <svg class="ml-2 w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"/>
                                </svg>
                ...
                <div class="max-w-[1420px] mx-auto">
                    <div id="productList" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                        <c:forEach items="${productList}" var="p">
                            <div class="bg-white rounded-lg" data-name="${p.productName}" data-price="${p.price}">
                                <a href="product-detail?pid=${p.id}">
                                    <img class="w-[300px] h-50 object-cover rounded-md mb-4" src="${p.image}" alt="">
