                    ...
                    <form id="search" action="product-manager" method="get" class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" name="priceRange" id="priceRange" onchange="onChangeSubmit('search')">
                                ...
                                <option ${currentPriceRange == "500to1M" ? 'selected' : ''} value="500to1M">from 500 to 1k</option>
                                <option ${currentPriceRange == "1Mto5M" ? 'selected' : ''} value="1Mto5M">1 to 5k</option>
                                <option ${currentPriceRange == "5Mto10M" ? 'selected' : ''} value="5Mto10M">5  to 10K</option>
                                ...
                                <option ${currentPriceRange == "30andUp" ? 'selected' : ''} value="30andUp">above 30k</option>
                            </select>
                        </div>
                    </form>
                    <br><!-- comment -->
